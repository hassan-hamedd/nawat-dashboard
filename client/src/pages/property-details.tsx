            ...
            <Stack direction="row" flexWrap="wrap" justifyContent="space-between" alignItems="center" gap={2}>
              <Box>
                ...
                <Stack mt={0.5} direction="row" alignItems="center" gap={0.5}>
                  <Typography fontSize={14} color="#808191">Keywords: {propertyDetails.location}</Typography>
                </Stack>
              </Box>

              <Box>
                <Typography fontSize={16} fontWeight={600} mt="10px" color="#11142D">Read Time</Typography>
                <Stack direction="row" alignItems="flex-end" gap={1}>
                  <Typography fontSize={22} fontWeight={700} color="#475BE8">{propertyDetails.price} mins</Typography>
                </Stack>
              </Box>
            </Stack>
